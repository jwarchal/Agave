...
<div id='admin-page-controls'>
	<h4>Options</h4>
	<p><a class='fm-button' href='<?php print $agave->url."admin/users/types/add" ?>'>Add user type</a></p>
	<p><a class='fm-button' href='<?php print $agave->url."admin/users" ?>'>Browse Users</a></p>
</div>
