...
foreach($presets as $num=>$pre){
    ...
    print('<a href="'.$agave->url.'admin/transcoder/preset/delete/'.$pre['presetKey'].'">Delete this preset.</a>');
    print("<br/><br/>");
}
print('<strong><a href="'.$agave->url.'admin/transcoder/preset/create">Create a new preset.</a></strong>');
?></pre>