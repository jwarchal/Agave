...
<a href='<?php print $agave->url."files/upload" ?>'>Upload File</a>
...
<table>
	...
	<tr <?php if($i%2 != 0) print "class='table-zebra'" ?>>
		...
		<td>
			<a href='<?php print $agave->url."files/".$files[$i]->fileKey ?>'>view</a> - 
			<a href='<?php print $agave->url."files/".$files[$i]->fileKey."/edit" ?>'>edit</a>
		</td>
	</tr>
	<?php endfor; ?>
</table>
